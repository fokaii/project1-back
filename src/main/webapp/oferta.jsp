...
<!-- КАТАЛОГ -->
    <div class="section-header">
        <h2>Сайт не является публичной офертой</h2>
    </div>
    ...
    <div class="center-block">
        <div class="site-info">
            ...
            <p>Нажатие на кнопку «Оформить заказ», а также последующее заполнение тех или иных форм, не накладывает на владельцев сайта никаких обязательств.</p>
        </div>
    </div>
